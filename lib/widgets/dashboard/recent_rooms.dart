  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border(top: BorderSide(color: AppColors.outlineVariant.withValues(alpha: 0.12))),
      ),
      child: Column(
          ...
          Expanded(
            child: uiState.isLoading && uiState.data == null
                ...
                : uiState.error != null && uiState.data == null
                    ? Center(child: Text(uiState.error!, style: const TextStyle(color: AppColors.error)))
                    : (uiState.data?.recentRooms ?? []).isEmpty
                        ? Center(
                            child: Text(
                              'You haven\'t joined any rooms yet.',
                              style: TextStyle(color: AppColors.onSurfaceVariant.withValues(alpha: 0.6), fontSize: 13, fontStyle: FontStyle.italic),
                            ),
                          )
                        : ListView.separated(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      Text(
                                        ...
                                        style: const TextStyle(color: AppColors.onSurface, fontWeight: FontWeight.w600, fontSize: 14),
                                      ),
                                      ...
                                      Row(
                                        children: const [
                                          ...
                                          SizedBox(width: 6),
                                          Text('Rejoin', style: TextStyle(color: AppColors.primary, fontSize: 12, fontWeight: FontWeight.w600)),
                                        ],
                                      ),
                                    ],
                                  ),
