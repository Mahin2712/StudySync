  ...
  Widget build(BuildContext context) {
    ...
    if (lb.isEmpty) {
      return Container(
        ...
        child: const Column(
          children: [
            Icon(Icons.emoji_events_outlined, color: AppColors.outlineVariant, size: 28),
            SizedBox(height: 8),
            Text(
    ...
    return Theme(
      ...
      child: ExpansionTile(
        ...
        title: const Text('Top Studiers', style: TextStyle(color: AppColors.onSurface, fontSize: 13, fontWeight: FontWeight.w600)),
        children: lb.asMap().entries.map((entry) {
          ...
          return ListTile(
            ...
            title: Text(user.username, style: const TextStyle(color: AppColors.onSurface, fontSize: 13)),
            trailing: Text(user.formattedHours, style: const TextStyle(color: AppColors.primary, fontSize: 12, fontWeight: FontWeight.w600)),
          );
        }).toList(),
      ),
    );
