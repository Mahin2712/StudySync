...
class _RoomDetailScreenState extends State<RoomDetailScreen>
  ...
  Future<void> _initialLoad() async {
    ...
    await Future.wait([_loadMembers(), _loadSessionState()]);
  ...
  void _startUiTicker() {
    _uiTicker = Timer.periodic(const Duration(seconds: 1), (_) {
      ...
      _recentlyMissedUserIds.removeWhere(
  ...
  _ConnStatus get _connectionStatus {
    final socketError =
        _socketStatus.contains('CLOSED') ||
        _socketStatus.contains('CHANNEL_ERROR');
  ...
  void _showStartDialog() {
    ...
    final List<String> chapters = isCustom
        ? []
        : ChapterService.getChapters(subjectKey);
  ...
  void _showCheckinPopup() {
    ...
    _checkinGraceTimer = Timer(const Duration(seconds: 60), () => _autoStop());
  }
  ...
  Widget _buildConnectionDot() {
    ...
    return Tooltip(
      message:
          '$label · last event ${DateTime.now().difference(_lastRealtimeEvent).inSeconds}s ago',
      ...
      child: Column(
        ...
        children: [
          ...
          _sideItem(
            ...
            active: _isStudying,
            disabled: !_isStudying,
          ),

          _sideItem(Icons.how_to_reg_outlined, 'Check-in', disabled: true),

          _sideItem(Icons.info_outline_rounded, 'Session Info', disabled: true),
          ...
          child: AnimatedBuilder(
            ...
            builder: (context2, child2) => Container(
              ...
              decoration: BoxDecoration(
                ...
                gradient: RadialGradient(
                  colors: [
                    (_isStudying ? _green : _primary).withValues(alpha: 0.06),
              ...
              children: [
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    border: Border.all(
                      color: (_isStudying ? _green : _outline).withValues(
                        alpha: _isStudying ? 0.2 : 0.12,
                      ),
                    ),
                  ),
    ...
    return Column(
      ...
      children: [
        Container(
          ...
          child: const Icon(Icons.groups_2_outlined, color: _primary, size: 30),
        ),
    ...
    return Column(
      ...
      children: [
        ...
        const Text(
          ...
          style: TextStyle(fontSize: 10, color: _green, letterSpacing: 2),
        ),
        ...
        child: Tooltip(
          ...
          child: AnimatedContainer(
            ...
            child: isRecentlyMissed
                ...
                : isActiveStudier
                ? Icon(Icons.self_improvement_rounded, color: iconCol, size: 22)
                : hasUser
  ...
  Widget _buildMemberTile(
    int index,
    Map<String, StudySessionModel> sessionMap,
  ) {
...
class _DotPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final paint = Paint()
      ..color = (studying ? const Color(0xFF4CAF50) : const Color(0xFFADCBDB))
          .withValues(alpha: 0.06);
